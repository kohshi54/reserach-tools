...
server_df = pd.read_csv('serverasnrtt.csv')
...
def resample_and_fill(group, min_rtt):
    ...
    full_range = pd.date_range(start='2024-05-13 15:00:00', end='2024-05-13 15:59:00', freq='1T')
...
df_resampled.to_csv('odrtt_timeseries.csv')
